...
<title>Your Cart | Mpemba Marketplace</title>
...
<!-- Editorial Header -->
<header class="mb-12">
<h1 class="font-headline font-black text-5xl md:text-6xl text-primary tracking-tighter mb-2">Your Cart</h1>
<p class="text-on-surface-variant max-w-lg">Review your selection of artisanal pieces before proceeding to our secure checkout.</p>
</header>
