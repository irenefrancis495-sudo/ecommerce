...
<body class="bg-surface text-on-surface selection:bg-secondary-container">
    ...
    <main class="pt-24 min-h-screen">
        ...
        <section class="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="md:col-span-2 md:row-span-2 group" data-id="7" data-name="The Saharan Nomad Robe" data-price="420" data-image="https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=1400&q=80">
