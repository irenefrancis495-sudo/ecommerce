...
<button class="mt-6 w-full py-4 rounded-lg bg-primary text-on-primary font-label text-xs uppercase tracking-widest hover:bg-primary-container hover:text-on-primary-container transition-all scale-102 flex justify-center items-center gap-2 add-to-collection">
                    Add to Collection
                </button>
</article>
    ...
    document.querySelectorAll('.add-to-collection').forEach(button => {
        button.addEventListener('click', function() {
            ...
            const item = {
                ...
                skinType: card.dataset.skinType,
