...
function get_top_selling() { 
    ...
    return is_array($top_selling) ? $top_selling : []; 
}
...
function get_revenue_series() {
    ...
    $revenue = [1200, 2400, 3800, 4500, 5200, 4800, 6100, 7000, 6900, 7200, 8000, 9000];
    return is_array($revenue) && array_reduce($revenue, fn($carry, $item) => $carry && is_numeric($item), true) ? $revenue : [];
}
